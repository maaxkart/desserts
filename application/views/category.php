 <div id="wrapper">
                ...
                <div class="content">
                    ...
                    <section class="parallax-section hero-section hidden-section" data-scrollax-parent="true">
                        <div class="bg par-elem "  data-bg="<?=base_url()?>assets/images/bg/b2.jpg" data-scrollax="properties: { translateY: '30%' }"></div>
                    ...
                    <section>
                        ...
                        <nav class="scroll-nav scroll-init">
                            ...
                            <ul>
                                ...
                                <li><a class="scroll-link" href="#menu-section-2"><span>Gelato</span></a></li>
                                <li><a class="scroll-link" href="#menu-section-3"><span>Frozen Yogurt</span></a></li>
                                <li><a class="scroll-link" href="#menu-section-4"><span>Kulfi</span></a></li>
                            ...
                            <div class="menu-wrapper single-menu fl-wrap" id="menu-section-1" data-scrollax-parent="true">
                                <div class="menu-wrapper-title fl-wrap">
                                    ...
                                    <div class="bg par-elem "  data-bg="<?=base_url()?>assets/images/bg/ice7.jpg" data-scrollax="properties: { translateY: '40%' }"></div>
                                    <div class="overlay"></div>
                                    <span class="menu-wrapper-title_number">01.</span>
                                </div>
                                <!-- hero-menu-item-->
                                <div class="hero-menu-item">
                                    <a href="<?=base_url()?>assets/images/menu/1.jpg" class="hero-menu-item-img image-popup"><img src="<?=base_url()?>assets/images/menu/thumbnails/1.jpg" alt=""></a>
                                ...
                                <!-- hero-menu-item-->
                                <div class="hero-menu-item">
                                    <a href="<?=base_url()?>assets/images/menu/2.jpg" class="hero-menu-item-img image-popup"><img src="<?=base_url()?>assets/images/menu/thumbnails/2.jpg" alt=""></a>
                                    <div class="hero-menu-item-title fl-wrap">
                                        <h6> Miso chicken</h6>
                                        <div class="hmi-dec"></div>
                                ...
                                <!-- hero-menu-item-->
                                <div class="hero-menu-item">
                                    <a href="<?=base_url()?>assets/images/menu/4.jpg" class="hero-menu-item-img image-popup"><img src="<?=base_url()?>assets/images/menu/thumbnails/4.jpg" alt=""></a>
                                    <div class="hero-menu-item-title fl-wrap">
                                        <h6> Garden salad</h6>
                                        <div class="hmi-dec"></div>
                                ...
                                <!-- hero-menu-item-->
                                <div class="hero-menu-item">
                                    <a href="<?=base_url()?>assets/images/menu/5.jpg" class="hero-menu-item-img image-popup"><img src="<?=base_url()?>assets/images/menu/thumbnails/5.jpg" alt=""></a>                                                        
                                    <div class="hero-menu-item-title fl-wrap">
                                ...
                                <!-- hero-menu-item-->
                                <div class="hero-menu-item">
                                    <a href="<?=base_url()?>assets/images/menu/6.jpg" class="hero-menu-item-img image-popup"><img src="<?=base_url()?>assets/images/menu/thumbnails/6.jpg" alt=""></a>                                                        
                                    <div class="hero-menu-item-title fl-wrap">
                                ...
                                <!-- hero-menu-item-->
                                <div class="hero-menu-item">
                                    <a href="<?=base_url()?>assets/images/menu/7.jpg" class="hero-menu-item-img image-popup"><img src="<?=base_url()?>assets/images/menu/thumbnails/7.jpg" alt=""></a>                                                        
                                    <div class="hero-menu-item-title fl-wrap">
                                ...
                                <!-- hero-menu-item-->
                                <div class="hero-menu-item">
                                    <a href="<?=base_url()?>assets/images/menu/8.jpg" class="hero-menu-item-img image-popup"><img src="<?=base_url()?>assets/images/menu/thumbnails/8.jpg" alt=""></a>                                                        
                                    <div class="hero-menu-item-title fl-wrap">
                            ...
                            <div class="menu-wrapper single-menu fl-wrap" id="menu-section-2" data-scrollax-parent="true">
                                <div class="menu-wrapper-title fl-wrap">
                                    ...
                                    <div class="bg par-elem "  data-bg="<?=base_url()?>assets/images/bg/b2.jpg" data-scrollax="properties: { translateY: '40%' }"></div>
                                    <div class="overlay"></div>
                                    <span class="menu-wrapper-title_number">02.</span>
                                </div>
                                <!-- hero-menu-item-->
                                <div class="hero-menu-item">
                                    <a href="<?=base_url()?>assets/images/menu/9.jpg" class="hero-menu-item-img image-popup"><img src="<?=base_url()?>assets/images/menu/thumbnails/9.jpg" alt=""></a>
                                    <div class="hero-menu-item-title fl-wrap">
                                ...
                                <!-- hero-menu-item-->
                                <div class="hero-menu-item">
                                    <a href="<?=base_url()?>assets/images/menu/10.jpg" class="hero-menu-item-img image-popup"><img src="<?=base_url()?>assets/images/menu/thumbnails/10.jpg" alt=""></a>                                                        
                                    <div class="hero-menu-item-title fl-wrap">
                                        <h6> Slow-Roasted Prime Rib</h6>
                                        <div class="hmi-dec"></div>
                                        <span class="hero-menu-item-price">$22</span>
                            ...
                            <div class="menu-wrapper single-menu fl-wrap" id="menu-section-3" data-scrollax-parent="true">
                                <div class="menu-wrapper-title fl-wrap">
                                    ...
                                    <div class="bg par-elem "  data-bg="<?=base_url()?>assets/images/bg/b4.jpg" data-scrollax="properties: { translateY: '40%' }"></div>
                                    <div class="overlay"></div>
                            ...
                            <div class="menu-wrapper single-menu fl-wrap" id="menu-section-4" data-scrollax-parent="true">
                                <div class="menu-wrapper-title fl-wrap">
                                    ...
                                    <div class="bg par-elem "  data-bg="<?=base_url()?>assets/images/bg/b3.jpg" data-scrollax="properties: { translateY: '40%' }"></div>
                                    <div class="overlay"></div>
