                                                    ...
                                                    <div class="single-slider fl-wrap">
                                                        <div class="swiper-container">
                                                            <div class="swiper-wrapper lightgallery">
                                                                <div class="swiper-slide hov_zoom"><img src="<?=base_url()?>assets/images/all/9.jpg" alt=""><a href="<?=base_url()?>assets/images/all/9.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a></div>
                                                                <div class="swiper-slide hov_zoom"><img src="<?=base_url()?>assets/images/all/10.jpg" alt=""><a href="<?=base_url()?>assets/images/all/10.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a></div>
                                                                <div class="swiper-slide hov_zoom"><img src="<?=base_url()?>assets/images/all/11.jpg" alt=""><a href="<?=base_url()?>assets/images/all/11.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a></div>
                                                            </div>
                                        ...
                                        <div class="post-related fl-wrap">
                                            ...
                                            <div class=" row">
                                                ...
                                                <div class="item-related col-md-4">
                                                    <a href="#"><img src="<?=base_url()?>assets/images/all/12.jpg"   alt=""></a>
                                                ...
                                                <!-- 2  --> 
                                                <div class="item-related col-md-4">
                                                    <a href="#"><img src="<?=base_url()?>assets/images/all/6.jpg"   alt=""></a>
                                                ...
                                                <!-- 3  --> 
                                                <div class="item-related col-md-4">
                                                    <a href="#"><img src="<?=base_url()?>assets/images/all/19.jpg"   alt=""></a>
                                        ...
                                        <div   class="single-post-comm fl-wrap">
                                            ...
                                            <ul class="commentlist clearafix">
                                                <li class="comment">
                                                    <div class="comment-body">
                                                        <div class="comment-author">
                                                            <img alt='' src='<?=base_url()?>assets/images/avatar/1.jpg' width="50" height="50">
                                                        </div>
                                                ...
                                                <li class="comment">
                                                    ...
                                                    <div class="comment-body">
                                                        <div class="comment-author">
                                                            <img alt='' src='<?=base_url()?>assets/images/avatar/2.jpg' width="50" height="50">
                                                        </div>
                                    ...
                                    <div class="main-sidebar fixed-bar fl-wrap">
                                        ...
                                        <div class="main-sidebar-widget fl-wrap">
                                            ...
                                            <div class="about-widget">
                                                <img src="<?=base_url()?>assets/images/all/19.jpg" alt="">
                                                <h4>Dessertz restaurant</h4>
                                        ...
                                        <div class="main-sidebar-widget fl-wrap">
                                            ...
                                            <div class="recent-post-widget">
                                                <ul>
                                                    <li>
                                                        <div class="recent-post-img"><a href="#"><img src="<?=base_url()?>assets/images/all/8.jpg" alt=""></a></div>
                                                    ...
                                                    <li>
                                                        <div class="recent-post-img"><a href="#"><img src="<?=base_url()?>assets/images/all/9.jpg" alt=""></a></div>
                                                        <div class="recent-post-content">
                                                            <h4><a href="#">Snowy Mountains Trip</a></h4>
                                                            <div class="recent-post-opt">
                                                                <span class="post-date">3 May 2016</span> 
                                                    ...
                                                    <li>
                                                        <div class="recent-post-img"><a href="#"><img src="<?=base_url()?>assets/images/all/11.jpg" alt=""></a></div>
                                                        <div class="recent-post-content">
                                                            <h4><a href="#">Snowy Mountains Trip</a></h4>
                                                            <div class="recent-post-opt">
                                                                <span class="post-date">3 May 2016</span> 
                                        ...
                                        <div class="main-sidebar-widget fl-wrap">
                                            ...
                                            <ul class="cat-item">
                                                    <li><a href="#">Gelato</a><span>12</span></li>
                                                    <li><a href="#">Frozen Yogurt</a><span>21</span></li>
                                                    <li><a href="#">Desserts</a><span>34</span></li>
                                                    <li><a href="#">Kulfi</a><span>8</span></li>
                                                    <li><a href="#">Raspberry</a><span>9</span></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <!-- main-sidebar-widget end-->
