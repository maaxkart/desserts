<div id="wrapper">
                ...
                <div class="content">
                    ...
                    <section class="parallax-section hero-section hidden-section" data-scrollax-parent="true">
                        <div class="bg par-elem "  data-bg="<?=base_url()?>assets/images/bg/b3.jpg" data-scrollax="properties: { translateY: '30%' }"></div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="text-block ">
                                        ...
                                        <a href="#" class="btn fl-btn">Explore Our Menu<i class="fal fa-long-arrow-right"></i></a>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                            ...
                                            <div class="single-slider fl-wrap">
                                                <div class="swiper-container">
                                                    <div class="swiper-wrapper lightgallery">
                                                        <div class="swiper-slide hov_zoom"><img src="<?=base_url()?>assets/images/all/4.jpg" alt=""><a href="<?=base_url()?>assets/images/all/4.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a></div>
                                                        <div class="swiper-slide hov_zoom"><img src="<?=base_url()?>assets/images/all/1.jpg" alt=""><a href="<?=base_url()?>assets/images/all/1.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a></div>
                                                        <div class="swiper-slide hov_zoom"><img src="<?=base_url()?>assets/images/all/2.jpg" alt=""><a href="<?=base_url()?>assets/images/all/2.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a></div>
                                                    </div>
                    ...
                    <section class="parallax-section dark-bg hidden-section" data-scrollax-parent="true">
                        ...
                        <div class="brush-dec"></div>
                        <div class="bg par-elem bg_tabs"  data-bg="<?=base_url()?>assets/images/bg/11.jpg" data-scrollax="properties: { translateY: '30%' }"></div>
                        <div class="overlay"></div>
                        <div class="container">
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="testi-item fl-wrap">
                                                <div class="testi-avatar"><img src="<?=base_url()?>assets/images/avatar/2.jpg" alt=""></div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="testi-item fl-wrap">
                                                <div class="testi-avatar"><img src="<?=base_url()?>assets/images/avatar/3.jpg" alt=""></div>
                                                <div class="testimonilas-text fl-wrap">
                                                    <h3>Frank Dellov</h3>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="testi-item fl-wrap">
                                                <div class="testi-avatar"><img src="<?=base_url()?>assets/images/avatar/4.jpg" alt=""></div>
                                                <div class="testimonilas-text fl-wrap">
                                                    <h3>Centa Simpson</h3>
                                                    <div class="star-rating" data-starrating="5"> </div>
                                                    <p>"Vestibulum orci felis, ullamcorper non condimentum non, ultrices ac nunc. Mauris non ligula suscipit, vulputate mi accumsan, dapibus felis. Nullam sed sapien dui. Nulla auctor sit amet sem non porta. "</p>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="testi-item fl-wrap">
                                                <div class="testi-avatar"><img src="<?=base_url()?>assets/images/avatar/5.jpg" alt=""></div>
                                                <div class="testimonilas-text fl-wrap">
